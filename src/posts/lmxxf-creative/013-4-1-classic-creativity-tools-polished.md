...
主要分支代表了思考的主要维度或方面。通过不同颜色的区分，我们能够快速识别不同的思维路径，避免混淆。
...
产品创新是SCAMPER法的主要应用领域，它能够帮助我们系统性地改进产品。
...
苹果公司的产品设计流程就体现了这种综合应用。设计师首先通过思维导图分析用户需求，然后运用六顶思考帽评估设计方案，最后通过SCAMPER法改进产品功能。
